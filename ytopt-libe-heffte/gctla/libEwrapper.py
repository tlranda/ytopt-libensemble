...
def parse(prs=None, args=None):
    ...
    args.seds = {
        ...
        ('mpi_ranks',): [(args.ens_template_export, "s/MPI_RANKS = .*/MPI_RANKS = {}/"),],
        ('worker_timeout',): [(args.ens_template_export, "s/'app_timeout': [0-9]*,/'app_timeout': {},/"),],
        ('application_scale',): [(args.ens_template_export, "s/APP_SCALE = .*/APP_SCALE = {}/"),],
        ('application_x',): [(args.ens_template_export, "s/APP_SCALE_X = .*/APP_SCALE_X = {}/"),],
        ('application_y',): [(args.ens_template_export, "s/APP_SCALE_Y = .*/APP_SCALE_Y = {}/"),],
        ('application_z',): [(args.ens_template_export, "s/APP_SCALE_Z = .*/APP_SCALE_Z = {}/"),],
